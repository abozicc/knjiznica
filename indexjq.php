...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <script type="text/javascript">
        ...
        $('.search-input').keyup(function(){$("#txtHint").load("connect.php?q=" + $(this).val());
...
if(!isset($_COOKIE['uname']))
    {
        ...
        <h5 class="naslov"> 
        Potraži odgovarajuću knjigu putem JQUERY (ajax metoda)
             </h5> 
          <div class="search">
            <form action="">
            <!-- <input class="search-input" type="text" id="txt1" onkeyup="showHint(this.value)"> -->
                
                <input class="search-input" type="text" id="txt1">
                </form>
